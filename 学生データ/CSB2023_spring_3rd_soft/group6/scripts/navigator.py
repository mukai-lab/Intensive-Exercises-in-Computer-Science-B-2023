...
class Navigator:
    goal = [[0.0, -0.2, 0.0, 1.0],[0.0, 0.2, 0.0, 1.0],[0.2, 0.2, 0.0, 1.0]]
    goal_number = 0
    def __init__(self):
    ...
    def callback_amcl(self, msg):
        if(abs(self.goal[self.goal_number][0] - msg.pose.pose.position.x) <= 0.1 and 
           abs(self.goal[self.goal_number][1] - msg.pose.pose.position.y) <= 0.1):
           # print("goal!")
