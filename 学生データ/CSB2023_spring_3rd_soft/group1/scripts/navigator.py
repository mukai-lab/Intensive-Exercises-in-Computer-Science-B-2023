...
class Navigator:
    ...
    def callback_amcl(self, msg):
        print(self.goal[self.goal_number][0]-msg.pose.pose.position.x,self.goal[self.goal_number][1]-msg.pose.pose.position.y)
        if((self.goal[self.goal_number][0]-msg.pose.pose.position.x)**2+(self.goal[self.goal_number][1]-msg.pose.pose.position.y)**2<0.01):
            print(self.goal_number,"th goal!")
